...
class Session(models.Model):
    ...
    # Contrabalanceamento: papel(R1/R2/CONTROL) -> {symbol, x, y}; gerado no backend.
...
class Event(models.Model):
    ...
    class Role(models.TextChoices):
        ...
        CONTROL = "CONTROL", "Botão controle"
    ...
    # Milissegundos desde started_at, medidos no cliente (performance.now()).
